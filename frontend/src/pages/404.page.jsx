...
const PageNotFound = () => {
    return (
        ...
        <p className="text-dark-grey text-xl leading-7 -mt-8">The page you are looking does not exists. Head back to <Link to="/" className="text-black underline">home page</Link> </p>
